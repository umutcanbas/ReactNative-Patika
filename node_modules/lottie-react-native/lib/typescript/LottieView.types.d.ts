import type { StyleProp, ViewStyle, LayoutChangeEvent, Animated } from 'react-native';
/**
...
declare type ColorFilter = {
    keypath: string;
    color: string;
};
declare type TextFilterIOS = {
    keypath: string;
    text: string;
};
declare type TextFilterAndroid = {
    find: string;
    replace: string;
};
/**
